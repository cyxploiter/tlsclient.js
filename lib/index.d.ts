...
import { DEFAULT_CLIENT_ID, DEFAULT_HEADERS, DEFAULT_HEADER_ORDER } from "./helpers/adapter";
 ...
 */
declare function createTLSClient(config?: TLSClientConfiguration): AxiosInstance;
export default createTLSClient;
export { DEFAULT_CLIENT_ID, DEFAULT_HEADERS, DEFAULT_HEADER_ORDER, TLSClientConfiguration, createTLSClient, };
